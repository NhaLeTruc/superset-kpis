...
def interactions_schema(extra_fields: list[StructField] | None = None) -> StructType:
    """
...
def metadata_schema(extra_fields: list[StructField] | None = None) -> StructType:
    """
...
def session_schema(extra_fields: list[StructField] | None = None) -> StructType:
    """
