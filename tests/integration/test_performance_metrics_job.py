"""
Integration tests for the performance metrics job (Job 03).

Tests the complete performance analytics pipeline including:
- Percentile calculations (P50, P95, P99)
- Device performance correlation
- Statistical anomaly detection
- Performance metrics by app version
"""
import pytest
...
class TestPerformanceMetricsJob:
    """Integration tests for performance metrics job."""
    ...
    def test_device_correlation_with_varied_performance(self, spark):
        ...
        from src.transforms.performance_transforms import calculate_device_correlation
    ...
    def test_statistical_anomaly_detection(self, spark):
        ...
        from src.transforms.performance_transforms import detect_anomalies_statistical
        from pyspark.sql.types import StructType, StructField, StringType, IntegerType, TimestampType
